...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      corners.forEach((corner, i) => {
        ...
        // High-performance linear interpolation (lerp)
        const lerpFactor = 0.22 * strength;
  ...
  return (
    <div ref={cursorRef} className="target-cursor-wrapper" style={{ opacity: 0, transition: 'opacity 0.15s ease-out' }}>
